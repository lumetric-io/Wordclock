...
#define PRODUCT_ID "wordclock-logo-nl-100x100-v1"
#define FIRMWARE_VERSION "logo-nl-100x100-v1-26.2.10-rc.7"
#define UI_VERSION "ui-logo-nl-100x100-v1-26.2.10-rc.7"
